...
def test(args):
    ...
    loader = data_loader( root='/datasets/cityscapes/', is_transform=True, img_norm=args.img_norm, test_mode=True)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        nargs="?",
        type=str,
        default="runs/fcn8s_cityscapes/20201216_162926/fcn8s_cityscapes_best_model.pkl",
